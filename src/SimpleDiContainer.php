...
use SimpleDi\Exception\ContainerException;
use SimpleDi\Exception\DependencyException;
use SimpleDi\Exception\EntityException;
use SimpleDi\Exception\EntityNotFoundException;
